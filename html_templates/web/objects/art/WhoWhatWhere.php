...
WagWhoWhatWhereQueryForm extends BaseDetailedQueryForm
{
	...
	WagWhoWhatWhereQueryForm ()
	{
		...
		$this->Fields = array(
			...
			'TitMainTitle|TitSeriesTitle|TitCollectionTitle|TitTitleNotes|TitObjectCategory',
		...
		$this->ExtraStrings = array(
			...
			"TitMainTitle|TitSeriesTitle|TitCollectionTitle|TitTitleNotes|TitObjectCategory" => "What",
