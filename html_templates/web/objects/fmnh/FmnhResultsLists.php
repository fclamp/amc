...
//=====================================================================================================
class
FmnhStandardResultsList extends BaseStandardResultsList
{
	function
	FmnhStandardResultsList()
	{
		...
		$this->mapperStylesheet = "mapper/style/mapdisplay.xsl";
        ...
        display()
        {
                ...
                print <<< HTML
					...
					// can add lat/long restriction to
					// query if wanted - check what fields
					// in client and do something like:
...
//=====================================================================================================
class
FmnhContactSheet extends BaseContactSheet
{
	function
	FmnhContactSheet()
	{
