...
class
ImaBasicQueryForm extends BaseBasicQueryForm
{
...
}  // end ImaBasicQueryForm class

class
ImaAdvancedQueryForm extends BaseAdvancedQueryForm
{
	var $Options = array(	'any' => 'SummaryData|AdmWebMetadata',
					'title' => 'TitMainTitle|TitTitleNotes',
					'notes' => 'NotNotes|TitTitleNotes',
...
}  // end ImaAdvancedQueryForm class
	

class
ImaDetailedQueryForm extends BaseDetailedQueryForm
{
...
} // End ImaDetailedQueryForm class
?>
