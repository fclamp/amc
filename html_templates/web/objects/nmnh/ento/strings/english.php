...
// Query Form Strings
	...
	"ONLY_WITH_IMAGES"					=> "List only items with images",
...
// Catalogue Field Names
        ...
        "BioCountryLocal:1"                                     => "Country",
        "BioCountryLocal_tab"		                        => "Country",
        "BioCruiseNumberLocal"                                  => "Cruise Number",
        "BioDateVisitedFromLocal"                               => "Collection Date",
        "BioDepthFromMet"                                       => "Depth From (met)",
        "BioDepthToMet"                                         => "Depth To (met)",
        ...
        "BioVerbatimLocality"                                   => "Locality",
        "BioVesselNameLocal"                                    => "Vessel Name",
        "CatBarcode"                                 		=> "Barcode",
        "CatCatalog"                                 		=> "Catalog",
        "CatCollectionName_tab"                                 => "Collection",
        "CatNumber"                                             => "USNM Number",
        "CatOtherNumbersType_tab"                               => "Other Numbers Type",
        "CatOtherNumbersValue_tab"                              => "Archive ID Number",
        "CatOtherNumbersValue:1"                              	=> "Archive ID Number",
        ...
        "ColParticipantRefLocal_tab"                            => "Collector",
	...
	"IdeCommonNameLocal_tab"				=> "Common Name",
        ...
        "IdeFiledAsIdentifiedByRef"                             => "Identified By",
        "IdeFiledAsName"                                        => "Name",
        "IdeFiledAsName"                                        => "Scientific Name",
        "IdeFiledAsOrder"                                       => "Order",
        "IdeFiledAsPhylum"                                      => "Phylum",
        "IdeFiledAsQualifiedNameWeb"                            => "Scientific Name",
        ...
        "IdeQualifiedName_tab"                                  => "Scientific Name",
	...
	"LocPermanentLocationLocal"				=> "Storage Location",
        "MinCountry"                        			=> "Country",
        "MinName"                                               => "Name",
        ...
        "ZooPreparation_tab"                                    => "Medium",
        "ZooPreparedBy_tab"                                     => "Preparation",
        "ZooSex_tab"                                            => "Sex",
        "ZooStage_tab"                                          => "Stage",
...
// taxonomy fields
        "CitTaxonRef:1->etaxonomy->WebScientificName"                   => "Scientific Name",
        "CitTaxonRef_tab->etaxonomy->WebScientificName"                 => "Scientific Name",
        "IdeFiledAsRef->etaxonomy->ClaClass"                            => "Class",
        "IdeFiledAsRef->etaxonomy->ClaFamily"                           => "Family",
        "IdeFiledAsRef->etaxonomy->ClaOrder"                            => "Order",
        "IdeFiledAsRef->etaxonomy->ClaPhylum"                           => "Phylum",
        "IdeFiledAsRef->etaxonomy->ComName_tab"                         => "Common Name",
        "IdeFiledAsRef->etaxonomy->WebScientificName"                   => "Scientific Name",
...
// collection events fields
        ...
        "BioEventSiteRef->ecollectionevents->AquRiverBasin"             => "River Basin",
	...
	"BioEventSiteRef->ecollectionevents->ExpStartDate"		=> "Collection Date",
        "BioEventSiteRef->ecollectionevents->ExpExpeditionName"         => "Expedition Name",
	"BioEventSiteRef->ecollectionevents->LatPreferredCentroidLatDec"	=> "Latitude",
	"BioEventSiteRef->ecollectionevents->LatPreferredCentroidLongDec"	=> "Longitude",
        ...
        "BioEventSiteRef->ecollectionevents->LocNearestNamedPlace"      => "Nearest Named Place",
        ...
        "BioEventSiteRef->ecollectionevents->TerVerbatimElevation"      => "Elevation",
...
// parties fields
	...
	"ColParticipantRef_tab->eparties->NamFullName"			=> "Collector",
	...
	"ZooPreparedByRef_tab->eparties->SummaryData"			=> "Illustrator",
	"ZooPreparedByRef:1->eparties->SummaryData"			=> "Illustrator",

// multimedia fields
        "MulMultiMediaRef_tab->emultimedia->MulDescription_tab"		=> "Multimedia Description",
