...
class
MhsoxStandardDisplay extends BaseStandardDisplay
{
	// Set default in the constructor
	function
	MhsoxStandardDisplay()
	{
		...
		$part_apsect_description = new Table();
		$part_apsect_description->Name = 'Physical';
		$part_apsect_description->Columns = array(
					'PhyPartPart_tab',
					'PhyPartAspect_tab',
					'PhyPartDescription0',
					);
		$part_apsect_description->Headings = array(
					'Part',
					'Aspect',
					'Description',
					);
		...
		$this->Fields = array
				(
					...
					'PhyMaterial_tab',
					'TitPreviousAccessionNo_tab', //Other Number
					$narratives,// narratives
					$physicalTable,
					$part_apsect_description
...
class
MhsoxNarrativeDisplay extends BaseStandardDisplay
{
	function
	MhsoxNarrativeDisplay()
	{
...
class
MhsoxPartyDisplay extends BaseStandardDisplay
{
