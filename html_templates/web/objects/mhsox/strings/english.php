...
// Catalogue Field Names
	...
	"TitPreviousAccessionNo_tab" => "Other No",
	"CreBriefDescription"	=>	"Brief Decription",
	"PhyPartPart_tab"	=>	"Part",
	"PhyPartAspect_tab"	=>	"Aspect",
	"PhyPartDescription0"	=>	"Description",
	"CreProvenance"		=>	"Provenance",
	"TitInventoryNo"	=>	"Inventory No",
	// Party Field Names
	"NamTitle"		=> "Title",
	"NamFirst"		=> "First Name",
	"NamLast"		=> "Last Name",
	...
	"CreCreatorRef_tab->eparties->SummaryData"	=> "Creator Name",	
	"LocMuseum"		=> "Museum",
	"TitaccessionNo|TitPreviousAccessionNo_tab" => "Accession Number",
	"CreBriefDescription" => "Brief Description",
