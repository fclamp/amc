...
// Catalogue Field Names
	...
	"BioOceanLocal_tab"	=> "Ocean",
	"BioOceanLocal:1"	=> "Ocean",
	"BioCountryLocal_tab"	=> "Country",
	"BioCountryLocal_tab|MinCountry"=> "Country",
	"BioCountryLocal:1"	=> "Country",
	"BioSeaGulfLocal_tab"	=> "Sea/Gulf",
	"BioDistrictCountyShireLocal_tab"	=> "District/County",
	"BioProvinceStateLocal_tab"	=> "Province/State",
	"BioProvinceStateLocal_tab|MinState"=> "Province/State",
