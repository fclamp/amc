...
/*  
 $Source: /home/cvs/emu/emu/master/web/objects/common/TaxonomyResultsLists.php,v $
 $Revision: 1.11 $
...
TaxonomyStandardResultsList extends BaseStandardResultsList
{
	...
	function display()
	{
		...
		$mapButton1 = '<input id="mapButton1" 
				...
				disabled="1"
				onMouseOver=""
				type="submit" value="'.$this->_STRINGS[MAP_BUTTON].'"/>';
		$mapButton2 = '<input id="mapButton2" 
				class="disabledLinkLikeButton" 
				disabled="1"
				onMouseOver=""
				type="submit" value="'.$this->_STRINGS[MAP_BUTTON].'"/>';
		$clearAllButton1 = '<input id="mapClearButton1" 
				class="LinkLikeButton" 
				onClick="SetCheckBoxes(0)"
				type="reset" value="Clear All Selections"/>';
		$selectAllButton1 = '<input id="mapAllButton1" 
				class="LinkLikeButton" 
				onClick="SetCheckBoxes(\'checked\')"
				type="button" value="Select All"/>';
		$clearAllButton2 = '<input id="mapClearButton2" 
				class="LinkLikeButton" 
				onClick="SetCheckBoxes(0)"
				type="reset" value="Clear All Selections"/>';
		$selectAllButton2 = '<input id="mapAllButton2" 
				class="LinkLikeButton" 
				onClick="SetCheckBoxes(\'checked\')"
				type="button" value="Select All"/>';
...
HTML;
		...
		$this->printControls(array($mapButton1,$selectAllButton1,$clearAllButton1));
...
HTML;
		...
		foreach ($allIrns as $rec => $irn)
		{
			...
			if ($duplicates > 0)
				...
				print "<td align='center'><input type='checkbox' 
					onClick='AllowMap();'
				name='query_term_irn$rownum' value='&lt;irn&gt;$irn&lt;/irn&gt;' /></td>";
		...
		<tr>
		  <td width="25%" align="left" nowrap="nowrap">
HTML;
		$this->printControls(array($mapButton2,$selectAllButton2,$clearAllButton2));
		print <<< HTML
		  </td>
		  <td width="75%" align="right">
HTML;
...
HTML;
	...
	function printControls($controls)
	{
		...
		print( "<span style='font: $this->FontFace $this->FontSize $this->TextColor'>");
