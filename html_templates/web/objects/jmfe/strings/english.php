...
// Catalogue Field Names
	...
	"irn_1"				=> "Catalog Number",
	"SumItemClass"		=> "Item Type",
	"TitItemDescription"	=> "Item Description",
	"TitItemType"		=> "Item Type",
	"SumAssocPartyLocal_tab" => "Associated Party",
