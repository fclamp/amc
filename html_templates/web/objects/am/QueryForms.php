...
class AmBasicQueryForm extends BaseBasicQueryForm
{
	...
	var $Options = array(
		'anywhere' => 'BioMicrohabitatDescription|CatRegNumber|CitTypeStatusCitationsCombine_tab|DeaDeaccessionMethod|ExtendedData|LocSiteLocal|LocSubstrate|MetClass|MetGroup|MetName|MetTypeSymbol|MinClass|MinColor|MinCut|MinGroup|MinSpecies|MinVariety|ObjKeywords_tab|ObjLabel|ProCollectionArea|ProCountry_tab|ProPlace|ProStateProvince_tab|QuiHabitat_tab|QuiRadiusVerbatim|QuiPreciseLocationLocal_tab|QuiTaxonLocal|QuiTaxonomyClass|QuiTaxonomyFamily|QuiTaxonomyGenus|QuiTaxonomyOrder|QuiTaxonomyPhylum|QuiTaxonomySpecies|RocClass|RocRockName|SumArchSiteName|SumCategory|SumItemName|TekDescription|TekName|TekShape|ZooSex_tab|ZooStage_tab|QuiTaxonomyCommonName',
...
class AmAdvancedQueryForm extends BaseAdvancedQueryForm
{
	...
	var $Options = array(
		...
		'summary' => 'ExtendedData',
		'habitat' => 'QuiHabitat_tab|BioMicrohabitatDescription',
		'site/collection'	=> 'LocSubstrate|QuiRadiusVerbatim|QuiPreciseLocationLocal_tab|LocSiteLocal|ProPlace|ProCollectionArea|ProCountry_tab|ProStateProvince_tab',
		'anthropology'		=> 'SumItemName|ObjKeywords_tab|ObjLabel|DeaDeaccessionMethod|SumArchSiteName|ProCollectionArea|ProCountry_tab|ProPlace|ProStateProvince_tab|ProStateProvince_tab',
		'meteorite'		=> 'MetClass|MetGroup|MetName|MetTypeSymbol',
		'mineral'		=> 'MinClass|MinColor|MinCut|MinGroup|MinSpecies|MinVariety',
		'rock'			=> 'RocClass|RocRockName',
...
class AmDetailedQueryForm extends BaseDetailedQueryForm
{
	...
	var $Fields = array(
		...
		'CitTypeStatusCitationsCombine_tab',
		'QuiTaxonomyCommonName',
		'ZooSex_tab',
		'ZooStage_tab',
		'LocSiteLocal',
		#'QuiLatitude0',
#		'QuiPreferredCentroidLatitude',
#		'QuiLongitude0',
#		'QuiPreferredCentroidLongitude',
		'QuiRadiusVerbatim',
	...
	var $Hints = array(
		...
		'QuiTaxonomySubSpecies'		=> '',
		'QuiTaxonomyCommonName'	=> '[ eg. Wombat ]',
		'QuiHabitat_tab'		=> '',
		'CatRegNumber'			=> '[ eg. P.67176 ]',
		'BioMicrohabitatDescription'	=> '',
		'QuiTaxonLocal'			=> '[ eg Epiactis adeliana ]',
		'CitTypeStatusCitationsCombine_tab'		=> '[ eg. Holotype or cited Taxonomy Summary ]',
