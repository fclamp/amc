...
$DEFAULT_REPORT4		= "/$WEB_DIR_NAME/pages/$BACKEND_TYPE/Report4.php";
$DEFAULT_ESSAY			= "/$WEB_DIR_NAME/pages/$BACKEND_TYPE/Essay.php";
$DEFAULT_EXHLABEL		= "/$WEB_DIR_NAME/pages/$BACKEND_TYPE/ExhibitionLabel.php";
