...
QagBasicQueryForm extends BaseBasicQueryForm
{
	...
	var $Restriction = "(((ArtStatus contains 'a' OR ArtStatus contains 'b' OR ArtStatus contains 'c' OR ArtStatus contains 'd' OR ArtStatus contains 's') OR (ArtStatus is NULL)) AND (SumSearchCat contains 'Contemporary'))";
...
QagDetailedQueryForm extends BaseDetailedQueryForm
{
	...
	QagDetailedQueryForm()
	{
		...
		$this->DropDownLists = array(	
			...
			'SumSearchCat' => 'eluts:Search Cat.',
			'ArtMediaCategory' => 'eluts:Media Category',
		);
		...
		$this->LookupLists = array (
	 	...
	 	$this->Restriction = "(((ArtStatus contains 'a' OR ArtStatus contains 'b' OR ArtStatus contains 'c' OR ArtStatus contains 'd' OR ArtStatus contains 's') OR (ArtStatus is NULL)) AND (SumSearchCat contains 'Contemporary'))";
	}
