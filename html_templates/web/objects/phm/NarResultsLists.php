...
NarPhmObjectResultsList extends BaseStandardResultsList
{
	...
	display()
	{
		...
		print "<form method=POST action='NarContactSheetObject.php'>\n";
		...
		if ($this->ContactSheetPage != '')
		{
            ...
            /*
            globals $ALL_REQUEST;
            $generated = preg_split("/&amp;/", urldecode($this->ContactSheetPage) );
			$generated[0] = str_replace("NarContactSheetObject.php?Where=", "", $generated[0]);
			$generated[1] = str_replace("QueryPage=", "", $generated[1]);
			$generated[2] = str_replace("LimitPerPage=", "", $generated[2]);
			
			print "Contact Sheet URL: " . $this->ContactSheetPage . "<br>\n";
			print "All Request: " . $ALL_REQUEST . "<br>\n";
			print "Generated (1): " . $generated[0] . "<br>\n";
			print "Generated (2): " . $generated[1] . "<br>\n";
			print "Generated (3): " . $generated[2] . "<br>\n";
			
			print '<a href="#" onClick="makeRequest();">';
			print '<font color="' . $this->TextColor . '" face="' . $this->FontFace . '" size="' . $this->FontSize . '">';
			print $this->_STRINGS["CONTACT_SHEET"];
			print '</font></a>';
			*/
		}
...
NarPhmNarrativeObjectsResultsList extends BaseStandardResultsList
{
	...
	function
	NarPhmNarrativeObjectsResultsList()
	{
		$this->BaseStandardResultsList();
		$this->Database = 'ecatalogue';
	}
