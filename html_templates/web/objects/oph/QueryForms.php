...
class
OphBasicQueryForm extends BaseBasicQueryForm
{
...
}  // end OphBasicQueryForm class

class
OphAdvancedQueryForm extends BaseAdvancedQueryForm
{
	var $Options = array(	'any' => 'SummaryData|AdmWebMetadata',
					'title' => 'TitMainTitle|TitTitleNotes',
					'notes' => 'NotNotes|TitTitleNotes',
...
}  // end OphAdvancedQueryForm class
	

class
OphDetailedQueryForm extends BaseDetailedQueryForm
{
...
} // End OphDetailedQueryForm class
?>
