...
class DigirFactory
{
	function getInstance()
	{
		...
		if ($provider = new NhmfishDigir($BACKEND_TYPE,$WEB_ROOT,$WEB_DIR_NAME))
		{
			$provider->configure();
			return $provider;
		}
...
class NhmfishDigir extends DigirProvider
{
	...
	function testQueryTerms()
	{
		...
		return  "<filter>\n".
			"	<or>\n".
			"		<equals>\n".
			"			<darwin:Genus>Noturus</darwin:Genus>\n".
			"		</equals>\n".
			"		<equals>\n".
			"			<darwin:Genus>Silurus</darwin:Genus>\n".
			"		</equals>\n".
			"	</or>\n".
			"</filter>\n".
	...
	function configure()
	{
		...
		$this->setSimpleMapping('ScientificName','IdeScientificNameLocal_tab');
		$this->setSimpleMapping('TypeStatus_tab','CitTypeStatus');
...
if (isset($_REQUEST['test']))
{
	...
	{
		$actualProvider = new NhmfishDigir($BACKEND_TYPE,$WEB_ROOT,$WEB_DIR_NAME);
