...
NrmBasicQueryForm extends BaseDetailedQueryForm
{
	...
	NrmBasicQueryForm()
	{
		...
		$this->Fields = array(  
					'TitObjectType',
					'SummaryData|TitMainTitle|TitTitleNotes|NotNotes|CreCreatorLocal_tab|CreCountry_tab|EarAbstract|EarSourceTitle|EarPlace|EarPages|EarDocumentType',
					'TitMainTitle|TitTitleNotes|TitCollectionTitle|EarSourceTitle',
					'NotNotes|TitTitleNotes|RefBibliographicNotes_tab|EarAbstract',
					'CreCreatorLocal_tab',
		...
		$this->DropDownLists = array(	
						...
						'TitObjectType' => '|Earthquake|Hunter Photo Bank',
						);
	}
}
...
{
	var $Options = array(	'any' => 'SummaryData|TitMainTitle|TitTitleNotes|NotNotes|CreCreatorLocal_tab|CreCountry_tab|EarAbstract|EarSourceTitle|EarPlace|EarPages|EarDocumentType',
					'title' => 'TitMainTitle|TitTitleNotes|TitCollectionTitle|EarSourceTitle',
					'notes' => 'NotNotes|TitTitleNotes|RefBibliographicNotes_tab|EarAbstract',
					//'artist' => 'CreCreatorLocal_tab',
					);
