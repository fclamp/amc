...
class
GalleryUKStandardDisplay extends BaseStandardDisplay
{
	// Set default in the constructor
	function
	GalleryUKStandardDisplay()
	{
		...
		$narratives->LinksTo = "http://keemu.man.ac.uk/wagcustom/NarrativeDisplay.php";
...
class
GalleryUKPartyDisplay extends BaseStandardDisplay
{

	// Set default field in the constructor
	function
	GalleryUKPartyDisplay()
	{
		// Narratives Link
		$narratives = new BackReferenceField();
		$narratives->RefDatabase = "enarratives";
