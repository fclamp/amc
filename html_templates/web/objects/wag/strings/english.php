...
// Catalogue Field Names
	...
	"AdmPublishWebNoPassword"	=> "Published on Internet",
	"AdmPublishWebPassword"	=> "Published on Intranet",
...
// Event Strings
	"EveEventTitle"		=> "Exhibition Title",
	"EveTypeOfEvent"	=> "Exhibition Type",
	"EveEventDescription"	=> "Description",
	"EveIntendedAudience"	=> "Subject",
	"DatCommencementDate|DatCompletionDate"	=> "Exhibition Year",
	"SummaryData"		=> "Exhibition",
	);
?>
