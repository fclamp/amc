...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
	...
	<!--
	var widthfactor
	widthfactor = 200 * (screen.width / 1280)
	if (widthfactor > 200)
		widthfactor = 200

	document.write("<img border=\"0\" src=\"images/jacks.jpg\" width=" + widthfactor + "></font></td>")
	-->
	</SCRIPT>
...
<div align="center">
  <center>
<?php
require_once('../../objects/visualarts/QueryForms.php');
...
$queryform->HelpPage = '/emuwebvisualarts/pages/examples/shared/help/GalleryBasicQueryHelp.php';
$queryform->Show();
?>
  </center>
</div>
