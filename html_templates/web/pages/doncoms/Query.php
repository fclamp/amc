...
<table border="0" width="100%" cellspacing="5" cellpadding="2">
  <tr>
    <td width="80%" valign="top">
      <img border="0" src="images/logo.gif" width="148" height="85"><br>
      <font face="Tahoma" size="5" color="#336699"><b>Search Our Collections...</b></font>
      <p><font color="#336699" size="2" face="Tahoma">Welcome to the US Navy and Marine Corps museum
      collection's search page.&nbsp;Search a growing database cataloguing the collections of the museum.</font></p>
...
?>
	  ">
	  <img border="0" src="images/usnavy1.jpg" width="63" height="67"></a></font></td>
          <td width="50%" bgcolor="#FFFFE8" nowrap><font color="#336699" face="Tahoma" size="2">
            Records with images</font></td>
        </tr>
        <tr>
          <td width="50%" bgcolor="#FFFFE8"><font face="Tahoma"><a href="
<?php
...
$RandomQry->LowerIRN = 16000000;
$RandomQry->UpperIRN = 16500000;
$RandomQry->MaxNumberToReturn = 50;
$RandomQry->PrintRef();
?>
	  ">
	  <img border="0" src="images/usnavy2.jpg" width="62" height="67"></a></font></td>
...
?>
	  ">
	  <img border="0" src="images/usnavy3.jpg" width="64" height="67"></a></font></td>
...
require_once('../../objects/nmcpensacolaweb/QueryForms.php');
$queryform = new NmcPensacolaWebBasicQueryForm;
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BorderColor = '#336699';
$queryform->BodyColor = '#ffffe8';
$queryform->HelpPage = '/emuweb/examples/shared/help/NmcPensacolaWebBasicQueryHelp.php';
$queryform->Show();
?>
  </center>
</div>
