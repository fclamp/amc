...
<body bgcolor="#FFFFE8">
<img align=left border="0" src="images/logo.gif" width="148" height="85">
      <h3><font face="Tahoma" color="#336699">&nbsp;Search results...</font></h3>

<center>
<?php
require_once('../../objects/nmcpensacolaweb/ResultsLists.php');

$resultlist = new NmcPensacolaWebStandardResultsList;
