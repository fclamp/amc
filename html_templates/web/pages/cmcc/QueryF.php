...
$LangSelector->QueryUrl = $HTTP_SERVER_VARS[REQUEST_URI];
$LangSelector->LangType = '0,1';
$queryUrl = $LangSelector->Show();
print "<FORM action=\"$queryUrl\" method=GET>\n";

                PPrint("Cette page en: ", $this->FontFace, $this->FontSize, $this->FontColor);

                print "&nbsp;<select name=lang>\n";
                print " <option value=0 selected>Anglais</option>\n";
                print " <option value=1>Fran&ccedil;ais</option>\n";
                print "</select>&nbsp;<input type=submit value=\"Go!\">\n";
                print "</FORM>\n";


/*print "<p> Cette page en: <a href=\"$queryUrl\"> English </a>";*/
?>
</div>
<P>
<div align="center">
...
| --></font><font color="#0000FF"><u><a href="DtlQueryF.php">Recherche évoluée</a></u></font></font></p>
<!--<p align="center">&nbsp;</p>-->
<table border="0">
  <tr>
