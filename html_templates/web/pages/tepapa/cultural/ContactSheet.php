...
<title>Search results (Cultural History)</title>
</head>

<body bgcolor="#FFFFE8">
<img align=left border="0" src="../images/column.jpg" width="84" height="120">
      <h3><font face="Tahoma" color="#336699">&nbsp;Search results (Cultural History)...</font></h3>

<center>
<?php
require_once('../../../objects/tepapa/cultural/ResultsLists.php');

$resultlist = new TePapaContactSheet;
