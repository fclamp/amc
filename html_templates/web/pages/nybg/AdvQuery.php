...
<title>Search the NYBG Collection [ advanced ]</title>
</head>
...
<table border="0" width="100%" cellspacing="0" cellpadding="8">
  <tr>
    <td width="10%" nowrap><p align="center"><img border="0" src="images/nybg.jpg" width="194" height="138"></td>
    <td width="45%"><font face="Tahoma" color="#006400" size="4"><b>Advanced Search<br>
      </b></font><font color="#006400" face="Tahoma">Enter any terms in the
...
<div align="center">
<?php
require_once('../../objects/nybg/QueryForms.php');
$queryform = new NybgAdvancedQueryForm;
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BodyTextColor = '#006400';
