...
<?php
require_once('../../objects/common/LanguageSelector.php');
$LangSelector = new LanguageSelector;
$LangSelector->Item = 'ImageTitle';
$ItemDisplay = $LangSelector->display();
print "$ItemDisplay";
?>
	" width="270" height="42"></p>
<!--<center><font face="Tahoma" size="5" color="#003399"><H2> Welcome To Canadian War Museum WAR CLIPPINGS Project </H2></font></center>-->
<img align=left border="0" src="
<?php
require_once('../../objects/common/LanguageSelector.php');
$LangSelector = new LanguageSelector;
$LangSelector->Item = 'OrganizationIcon';
$ItemDisplay = $LangSelector->display();
print "$ItemDisplay";
?>
	">
    <!--<p align="center"><img border="0" src="images/logo_s.gif">-->
      <h3><font face="Tahoma" color="#003399">&nbsp;
<?php
require_once('../../objects/common/LanguageSelector.php');
$LangSelector = new LanguageSelector;
$LangSelector->Item = 'SearchResult';
$ItemDisplay = $LangSelector->display();
print "$ItemDisplay";
?>
...
<p align=center>
<?php
require_once('../../objects/warclip/DisplayObjects.php');
$display = new WarclipStandardDisplay;
