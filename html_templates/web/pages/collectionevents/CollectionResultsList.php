...
<head>
	...
	<title>KE EMu Collection Search Result</title> 
	<style>
		.linkLikeButton {
			border: none;
			cursor: pointer;
...
<?php
	...
	require_once('../../objects/collectionevents/CollectionResultsLists.php');
	...
	$resultlist->newSearch = 'CollectionQuery.php';
	$resultlist->mapperDataSource = 'webnew';

	$resultlist->DisplayThumbnails = 1;
	$resultlist->DisplayPage = "CollectionDisplay.php";
