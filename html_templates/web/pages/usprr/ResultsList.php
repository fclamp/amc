...
<center>
<?php
require_once('../../objects/usprr/ResultsLists.php');

$resultlist = new UsprrStandardResultsList;
...
$resultlist->QueryPage = "http://www-bprc.mps.ohio-state.edu/emuwebusprr/pages/usprr/Query.php";
$resultlist->Show();
