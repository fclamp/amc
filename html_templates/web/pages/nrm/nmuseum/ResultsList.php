...
<center>
<?php
require_once('../../../objects/nrm/nmuseum/ResultsLists.php');

//var_dump($ALL_REQUEST['col_TitObjectType']);

if ($ALL_REQUEST['col_TitObjectType'] == 'Museum Collection')
{
	$resultlist = new GalleryStandardResultsList;
}
elseif ($ALL_REQUEST['col_TitObjectType'] == "Sporting Person")
{
	$resultlist = new GallerySportResultsList;
}
elseif ($ALL_REQUEST['col_TitObjectType'] == 'Digger')
{
	$resultlist = new GalleryDiggerResultsList;
}
else
{
	$resultlist = new GallerySummaryDataResultsList;
}
