...
<img align=left border="0" src="images/column.jpg" width="84" height="120">
      <h3><font face="Tahoma" color="#336699">&nbsp;Object...</font></h3><br>

<p align="center">
<?php
require_once('../../objects/sam/DisplayObjects.php');
$display = new SamStandardDisplay;

$display->mapperUrl = '../../objects/common/emuwebmap.php';
$display->mapperDataSource = 'sam';
