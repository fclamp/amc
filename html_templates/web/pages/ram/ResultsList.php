...
$list = new RamStandardResultsList();
if ($Where != "")
	$list->Where = $Where;
...
$list->FontSize = "2";
$list->KeepImageAspectRatio = 1;
$list->ContactSheetPage = 'ContactSheet.php';
$list->DisplayPage = 'Display.php';
$list->QueryPage = 'Query.php';
?>
