...
<body bgcolor="#FFFFFF">
<img align=left border="0" src="images/nmlh.jpg" width="148" >
      <h3><font face="Tahoma" color="#777777">&nbsp;Our Collection...</font></h3><br>

<p align=center>
<?php
require_once('../../objects/nmlh/DisplayObjects.php');
$GLOBALS['DEFAULT_PARTY_DISPLAY_PAGE'] = 'PartyDisplay.php';
$display = new NmlhStandardDisplay;
$display->FontFace = 'Tahoma';
$display->FontSize = '2';
$display->BodyTextColor = '#777777';
$display->BorderColor = '#990000';
