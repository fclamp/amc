...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
	...
	<td width="50%" bgcolor="#F2F2F2"><font face="Tahoma"><a href="ResultsList.php?preconf=Marconi">

	  <img border="0" src="images/face.jpg" width="62" height="65"></a></font></td>
          <td width="50%" bgcolor="#F2F2F2" nowrap><font face="Tahoma" color="#336699" size="2">Marconi Objects</font></td>
        </tr>
        <tr>
	...
	<tr>
          <td width="50%" bgcolor="#F2F2F2"><font face="Tahoma"><a href="ResultsList.php?preconf=1">
	  <img border="0" src="images/world.jpg" width="64" height="63"></a></font></td>
...
<div align="center">
  <center>
<?php
require_once('../../objects/mhsox/QueryForms.php');

$queryform = new MhsoxBasicQueryForm;
...
<p Align="center"><font face="Tahoma"><u><font color="#0000FF"><a href="AdvQuery.php">Advanced Search</a></font></u>
