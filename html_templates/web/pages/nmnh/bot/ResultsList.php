...
<h4>
	<font face="Tahoma" color="#013567" size="2">
		<b>Search results </b> in our display... <br>
  		Click on "Detailed View" for detailed record information.<br>
		Over time more data and images will be made available.<br>
		<br>
		Use the back button on your browser to return to the previous search.
	</font>
</h4>
...
{
        $resultlist = new NmnhBotanyStandardResultsList;
        $resultlist->DisplayThumbnails = 0;
        $resultlist->DisplayPage = "Display.php";
        $resultlist->ContactSheetPage = ""; //was $resultlist->ContactSheetPage = $ContactSheet;
