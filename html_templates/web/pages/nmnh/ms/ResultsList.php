...
<center>
<?php
require_once('../../../objects/nmnh/ms/ResultsLists.php');
...
{
        $resultlist = new NmnhMsStandardResultsList;
        $resultlist->DisplayThumbnails = 0;
	$resultlist->DisplayPage = array
	(
                'ConditionField'                => 'CatDivision',
                'Default'                       => 'Display.php',
                'Gems & Minerals'               => 'DisplayGem.php',
                'Meteorites'                    => 'DisplayMet.php',
                'Petrology & Volcanology'       => 'DisplayPet.php',
                ''	                        => 'Display.php',
        );
