...
<title>Search the Army History Collection...</title>
</head>
...
<table border="0" width="100%" cellspacing="0" cellpadding="5">
  <tr>
    <td valign="top" width="10%" nowrap>
      <p align="center" valign="top"><font face="Tahoma"><img border="0" src="images/ahu.gif" width="116" height="65"></font></td>
    <td width="70%" valign="top"><font face="Tahoma" size="5" color="#336699"><b>Search the Army History Collection...</b></font>
      <p>
      <font color="#336699" size="2" face="Tahoma">Popular searches are
      available in the Quick Browse section to the right.</font>
      <br>
      <font color="#336699" size="2" face="Tahoma">Key word searches can be
      performed in the main search box below.&nbsp;</font>
    </td>
...
$RandomQry->LowerIRN = 25001;
$RandomQry->UpperIRN = 29317;
...
<div align="center">
  <center>
<?php
require_once('../../objects/ah/QueryForms.php');

$queryform = new AHBasicQueryForm;
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BorderColor = '#336699';
$queryform->BodyColor = '#ffffe8';
$queryform->HelpPage = '../../pages/shared/help/BasicQueryHelp.php';
$queryform->Show();
?>
  </center>
</div>
