...
require_once('../../objects/artbank/QueryForms.php');

$queryform = new GalleryDetailedQueryForm;
$queryform->Restriction = "TitObjectStatus contains 'Accessioned'";


$accession = new QueryField;
$accession->ColName = 'TitAccessionNo';
$accession->ColType = 'integer';

$height = new QueryField;
$height->ColName = 'PhyHeight_tab';
$height->ColType = 'integer';

$width = new QueryField;
$width->ColName = 'PhyWidth_tab';
$width->ColType = 'integer';

$depth = new QueryField;
$depth->ColName = 'PhyDepth_tab';
$depth->ColType = 'integer';

$diameter = new QueryField;
$diameter->ColName = 'PhyDiameter_tab';
$diameter->ColType = 'integer';

$weight = new QueryField;
$weight->ColName = 'PhyWeight_tab';
$weight->ColType = 'integer';

$val = new QueryField;
$val->ColName = 'ValAnnualRental';
$val->ColType = 'float';
