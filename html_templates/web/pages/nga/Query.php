...
?>
	  ...
	  <img border="0" src="images/face.jpg" width="62" height="65"></a></font></td>
        ...
        <tr>
          <td width="50%" bgcolor="#FFFFE8"><font face="Tahoma"><a href="
<?php
$pastdate = date("d-m-Y", mktime (0,0,0,date("m")-6,date("d"),  date("Y"))); 
$MediaLink = new PreConfiguredQueryLink;
$MediaLink->Where = "MulHasMultiMedia = 'y' AND AccMeetingDateLocal > DATE '" . $pastdate ."'";
$MediaLink->PrintRef();
?>
	  ">
...
<div align="center">
  <center>
<?php
require_once('../../objects/nga/QueryForms.php');

$queryform = new NgaBasicQueryForm;
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BorderColor = '#336699';
$queryform->BodyColor = '#ffffe8';
$queryform->HelpPage = '/emuweb/examples/shared/help/BasicQueryHelp.php';
$queryform->Show();
?>
  </center>
</div>
