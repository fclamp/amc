...
$MediaLink->Where = "TitObjectRating = 'highlight'";
$MediaLink->PrintRef();
?>
	  ">
	  <img border="0" src="images/disk.jpg" width="63" height="64"></a></font></td>
          <td width="50%" bgcolor="#FFFFE8" nowrap><font color="#336699" face="Tahoma" size="2">Collection Highlights</font></td>
        </tr>
        <tr>
...
<?php
require_once('../../objects/artdemo/EventQuery.php');
PrintEventQueryLink();
?>
	  ">
	  <img border="0" src="images/face.jpg" width="62" height="65"></a></font></td>
          <td width="50%" bgcolor="#FFFFE8" nowrap><font face="Tahoma" color="#336699" size="2">Items on Show</font></td>
        </tr>
        <tr>
          <td width="50%" bgcolor="#FFFFE8"><font face="Tahoma"><a href="
<?php
$MediaLink = new PreConfiguredQueryLink;
$MediaLink->Where = "TitObjectRating = 'new acquisition'";
$MediaLink->PrintRef();
?>
	  ">
	  <img border="0" src="images/world.jpg" width="64" height="63"></a></font></td>
          <td width="50%" bgcolor="#FFFFE8" nowrap><font face="Tahoma" color="#336699" size="2">New Acquisitions</font></td>
        </tr>
      </table>
    </td>
  </tr>
...
<div align="center">
  <center>
<?php
require_once('../../objects/artdemo/QueryForms.php');

$queryform = new ArtDemoBasicQueryForm;
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BorderColor = '#336699';
$queryform->BodyColor = '#ffffe8';
$queryform->HelpPage = '/emuweb/pages/shared/help/BasicQueryHelp.php';
$queryform->Show();
?>
  </center>
</div>
<p Align="center"><font face="Tahoma"><u><font color="#0000FF"><a href="AdvQuery.php">Who, What
search</a></font></u><font color="#336699">
| </font><font color="#0000FF"><u><a href="DtlQuery.php">Advanced search</a></u></font></font></p>
<p align="center">&nbsp;</p>
