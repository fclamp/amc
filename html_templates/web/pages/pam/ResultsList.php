...
<!--
	var widthfactor
        widthfactor = 100 * (screen.width / 1280)
	if (widthfactor > 200)
		widthfactor = 200
	document.write("<img id=\"myimg\" name=\"myimg\" align=left border=\"0\" src=\"images/panda.jpg\" width=" + widthfactor + ">")
-->
</SCRIPT>
...
<center>
<?php
require_once('../../objects/pam/ResultsLists.php');
