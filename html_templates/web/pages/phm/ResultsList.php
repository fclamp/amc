...
<b><center><u><font face="Tahoma" size="2" color="#336699">Catalogue</font></u></center></b>
<br>
<center>
<?php
require_once('../../objects/phm/ResultsLists.php');

$resultlist = new CatalogueResultsList;
$resultlist->BodyColor = '#FFFFE8';
$resultlist->NoResultsText = "<font face=Tahoma size=2 color=#336699>No Results Found</font>";
$resultlist->Width = '80%';
...
<b><center><u><font face="Tahoma" size="2" color="#336699">Accession Lots</font></u></center></b>
<br>
<center>
<?php
require_once('../../objects/phm/ResultsLists.php');

$resultlist = new AccessionResultsList;
$resultlist->ContactSheetPage = "ContactSheetAccession.php";
$resultlist->DisplayPage = "DisplayAccession.php";
$resultlist->NoResultsText = "<font face=Tahoma size=2 color=#336699>No Results Found</font>";
$resultlist->BodyColor = '#FFFFE8';
$resultlist->Intranet = 1;
$resultlist->Width = '80%';
...
<b><center><u><font face="Tahoma" size="2" color="#336699">Thesaurus</font></u></center></b>
<br>
<center>
<?php
require_once('../../objects/phm/ResultsLists.php');

$resultlist = new ThesaurusResultsList;
$resultlist->ContactSheetPage = "ContactSheetThesaurus.php";
$resultlist->Database = 'ethesaurus';
$resultlist->NoResultsText = "<font face=Tahoma size=2 color=#336699>No Results Found</font>";
$resultlist->DisplayPage = "DisplayThesaurus.php";
$resultlist->BodyColor = '#FFFFE8';
$resultlist->Width = '80%';
$resultlist->Intranet = 1;
$resultlist->HighlightColor = '#FFFFFF';
