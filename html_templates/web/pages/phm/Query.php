...
<title>Powerhouse Museum Collection Search</title>
</head>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    ...
    <td width="70%" valign="top"><font face="Tahoma" size="5" color="#336699">
	<center><img src="./images/phmother.jpg" border=0><img src="./images/phm.jpg" border=0></center>
      </font>
...
<?php
require_once('../../objects/phm/QueryForms.php');

$queryform = new CatalogueQueryForm;
$queryform->Title = "Search ...";
