...
<?php
	...
	$resultlist = new AmNarrativeResultsList;
	...
	<div id="content-container">
		<div id="content-wide">
			...
			<div id="content">
				...
				<ul id="emu-results">
					<li class="current"><a href="#"><span>List view</span></a></li>
					<li><?php $resultlist->printRedisplay($resultlist->ContactSheetPage, "<span>Contact sheet view</span>");?></li>
				</ul>
				<?php
					$resultlist->Show();
				?>
