	...
	<div id="content-container">
		<div id="content-wide">
			...
			<div id="content">
				...
				<?php require_once('../../objects/am/ImageDisplay.php');
					$display = new AMImageDisplay();
				?>	
				<h2> <?php print $display->Title(""); ?> </h2>
				<div class='emu-item-images'>
					<div class='emu-main-image'>
						<a href='javascript:history.go(-1)'>Go Back to Specimen Details</a>
						<?php print $display->ImageLink(); ?>
					</div>
					<div class='emu-image-credits'>
						<div class='emu-image-caption'>
							<?php print $display->Description(""); ?>
						</div><br/>
						<div class='emu-image-rights'>
							<?php print $display->Rights("&copy; assumed Australian Museum"); ?>
						</div><br/>
						<div class='emu-image-creator'>
							photographer: <?php print $display->Creator("unknown"); ?>
						</div>
					</div>
				</div>	
			</div>
