...
FieldSelector()
{
	...
	document.getElementById("preservationLbl").style.display = "none";
	...
	switch (arrayvalue)
	{
		case 'Mineralogy':
			...
			document.getElementById("creditLineLbl").style.display = "";
		...
		case 'Biology':
			document.getElementById("objNumLbl").style.display = "";
			document.getElementById("objNameLbl").style.display = "";
			document.getElementById("objnameCaption").innerHTML="Specimen Name";
			document.getElementById("assocPersonLabel").innerHTML="Associated Person/Organisation";
			...
			document.getElementById("descriptionLbl").style.display = "";
			document.getElementById("localityLbl").style.display = "";
			document.getElementById("preservationLbl").style.display = "";
			document.getElementById("creditLineLbl").style.display = "";
