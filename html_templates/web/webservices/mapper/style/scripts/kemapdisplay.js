...
{
	var emuwebPath = "../intranet/pages/"+ emuBackend + "/" + WebSection + "/";
...
{
	return "/" + EmuWebBase + "/pages/" + EmuBackendType + "/" + WebSection + "/ResultsList.php?Where=" + query;
}
...
var behaviours =  {
	...
	'.controlButton' : function(element)
	{
		element.onclick = function(ev)
		{
			...
			selectTool(toolId);
			if ((toolId == 'ReDraw') || (toolId == 'Reset') || (toolId == 'Print') || (toolId == 'Expand'))
			{
				mSubmit(CurrentTool);
			}
			stopEvent(ev);
