...
<xsl:variable name='referenceMap'>
	...
	<link rel="stylesheet" type="text/css" href="mapper/nmnh/style/nmnh.css" />
	<link rel="stylesheet" type="text/css" href="mapper/nmnh/style/nmnh_print.css" media='print' />
	...
	<script type='text/javascript'  src="mapper/nmnh/style/scripts/nmnhmapdisplay.js" />
