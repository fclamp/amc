...
class PortalFactory
{
	...
	{
		return new UsprrPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class UsprrPortal extends Portal
{
	var $systemName = "default USPRR Portal v2";
	...
	{
		return	
			"An USPRR Portal is a USPRR client specific portal\n\n".
			Parent::describe();
	}
