...
class FetcherDriverFactory
{
	...
	{
		return new RbgnswFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class RbgnswFetcherDriver extends FetcherDriver
{
	var $systemName = "RBGNSW FetcherDriver Portal v2";
	...
	{
		return	
			"A RBGNSW FetcherDriver is a RBGNSW client specific Fetcher Driver\n\n".
			Parent::describe();
	}
}
