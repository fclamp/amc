...
class DefaultTexxmlFetcher extends TexxmlFetcher
{
	...
	*/
	...
	function DefaultTexxmlFetcher($instanceDir='',$backendType='',$webRoot='',$webDirName='',$debugOn=true)
	{
		...
		$this->setKnownConcept("Genus","QuiTaxonomyGenus","Acacia");
		$this->setKnownConcept("Species","QuiTaxonomySpecies","adunca");
		$this->setKnownConcept("Latitude","QuiLatitude","","float");
		$this->setKnownConcept("Longitude","QuiLongitude","","float");
