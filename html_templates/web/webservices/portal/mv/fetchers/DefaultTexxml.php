...
class DefaultTexxmlFetcher extends TexxmlFetcher
{
	...
	var 	$serviceName = "MV EMu";

	/*  Describe Texxml configuration parameters
	 *  of the source
	*/
	var 	$sourceName = "EMu (AM EMu-Texxml)";
	var	$hostname = "localhost";
	var	$resource = "EMu";
	var 	$preferredRGB = '#eeeeee';
	var 	$preferredIcon = '';
	var 	$caheIsOn = false;
	...
	function DefaultTexxmlFetcher($instanceDir='',$backendType='',$webRoot='',$webDirName='',$debugOn=true)
	{
		...
		$this->setKnownConcept("Latitude","DarDecimalLatitude");
		$this->setKnownConcept("Longitude","DarDecimalLongitude");
		$this->setKnownConcept("ScientificName","DarScientificName");
		$this->setKnownConcept("Family","DarFamily");
		$this->setKnownConcept("Genus","DarGenus","Anopheles");
		$this->setKnownConcept("Species","DarSpecies");
		$this->setKnownConcept("description","SummaryData");
	}
