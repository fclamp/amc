...
class FetcherDriverFactory
{
	...
	{
		return new MvFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class MvFetcherDriver extends FetcherDriver
{
	var $systemName = "MV FetcherDriver Portal v2";
	...
	{
		return	
			"An MV FetcherDriver is an MV client specific Fetcher Driver\n\n".
			parent::describe();
	}
}
