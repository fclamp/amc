...
class PortalFactory
{
	...
	{
		return new MvPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class MvPortal extends Portal
{
	var $systemName = "default MV Portal v2";
	...
	{
		return	
			"An MV Portal is a MV client specific portal\n\n".
			parent::describe();
	}
