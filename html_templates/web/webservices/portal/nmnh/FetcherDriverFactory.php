...
class FetcherDriverFactory
{
	...
	{
		return new NmnhFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class NmnhFetcherDriver extends FetcherDriver
{
	var $systemName = "NMNH FetcherDriver Portal v2";
	...
	{
		return	
			"A NMNH FetcherDriver is a NMNH client specific Fetcher Driver\n\n".
			Parent::describe();
	}
}
