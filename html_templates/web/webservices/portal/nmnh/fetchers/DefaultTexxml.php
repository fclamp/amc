...
class DefaultTexxmlFetcher extends TexxmlFetcher
{
	...
	*/
	...
	function DefaultTexxmlFetcher($instanceDir='',$backendType='',$webRoot='',$webDirName='',$debugOn=true)
	{
		...
		$this->setKnownConcept("Genus","DarGenus","Lampsilis");
		$this->setKnownConcept("Species","DarSpecies","radiata");
		$this->setKnownConcept("Latitude","DarLatitude","","float");
		$this->setKnownConcept("Longitude","DarLongitude","","float");
