...
class PortalFactory
{
	...
	{
		return new TePapaPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class TePapaPortal extends Portal
{
	var $systemName = "default TePapa Portal v2";
	...
	{
		return	
			"A TePapa Portal is a TePapa client specific portal\n\n".
			parent::describe();
	}
