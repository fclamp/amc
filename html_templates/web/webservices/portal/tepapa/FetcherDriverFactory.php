...
class FetcherDriverFactory
{
	...
	{
		return new TepapaFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class TepapaFetcherDriver extends FetcherDriver
{
	var $systemName = "TePapa FetcherDriver Portal v2";
	...
	{
		return	
			"A TePapa FetcherDriver is a TePapa client specific Fetcher Driver\n\n".
			Parent::describe();
	}
}
