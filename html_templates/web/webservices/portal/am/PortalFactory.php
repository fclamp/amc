...
class PortalFactory
{
	...
	{
		return new AmPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class AmPortal extends Portal
{
	var $systemName = "default AM Portal v2";
	...
	{
		return	
			"A AM Portal is a AM client specific portal\n\n".
			Parent::describe();
	}
