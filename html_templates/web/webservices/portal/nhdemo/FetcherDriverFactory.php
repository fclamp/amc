...
class FetcherDriverFactory
{
	...
	{
		return new NhdemoFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class NhdemoFetcherDriver extends FetcherDriver
{
	var $systemName = "NHDEMO FetcherDriver Portal v2";
	...
	{
		return	
			"A NHDEMO FetcherDriver is a NHDEMO client specific Fetcher Driver\n\n".
			Parent::describe();
	}
}
