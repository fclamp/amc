...
class FetcherDriverFactory
{
	...
	{
		return new RsmFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class RsmFetcherDriver extends FetcherDriver
{
	var $systemName = "RSM FetcherDriver Portal v2";
	...
	{
		return	
			"A RSM FetcherDriver is a RSM client specific Fetcher Driver\n\n".
			Parent::describe();
	}
}
