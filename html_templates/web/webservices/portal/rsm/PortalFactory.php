...
class PortalFactory
{
	...
	{
		return new RsmPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class RsmPortal extends Portal
{
	var $systemName = "default Rsm Portal v2";
	...
	{
		return	
			"A Rsm Portal is a Rsm client specific portal\n\n".
			parent::describe();
	}
