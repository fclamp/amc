...
class PortalFactory
{
	...
	{
		return new DpiqPortal($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class DpiqPortal extends Portal
{
	var $systemName = "default DPIQ Portal v2";
	...
	{
		return	
			"A DPIQ Portal is a NMNH client specific portal\n\n".
			parent::describe();
	}
