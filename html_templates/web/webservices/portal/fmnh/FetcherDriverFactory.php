...
class FetcherDriverFactory
{
	...
	{
		return new FmnhFetcherDriver($this->backendType,$this->webRoot,$this->webDirName,$this->debugOn);
	}
}

class FmnhFetcherDriver extends FetcherDriver
{
	var $systemName = "FMNH FetcherDriver Portal v2";
	...
	{
		return	
			"A FMNH FetcherDriver is a FMNH client specific Fetcher Driver\n\n".
			parent::describe();
	}
}
