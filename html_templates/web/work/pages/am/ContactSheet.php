...
<?php require_once('../../objects/am/ResultsLists.php');
	...
	<div id="content-container">
		<div id="content-wide">
			...
			<div id="content">
				...
				<ul id="emu-results">
					<li><?php $resultlist->printRedisplay($resultlist->ResultsListPage, "<span>List view</span>");?></li>
					<li><a href=#><span>Contact sheet view</span></a></li>
				</ul>
				<?php
					$resultlist->Show();
				?>
