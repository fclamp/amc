...
QagStandardResultsList extends BaseStandardResultsList
{
	...
	*/
	...
	display()
	{
		...
		$this->printRedisplay($GLOBALS['DEFAULT_REPORT4'], "Report4");
		PPrint(' | ', 
			$this->FontFace, 
			$this->FontSize, 
			$this->TextColor);
		PPrint(' ', 
			...
			$this->FontSize, 
			$this->TextColor);
		$this->printRedisplay($GLOBALS['DEFAULT_ESSAY'], "Essay");
		PPrint(' | ', 
			$this->FontFace, 
			$this->FontSize, 
			$this->TextColor);
		PPrint(' ', 
			...
			$this->FontSize, 
			$this->TextColor);
		$this->printRedisplay($GLOBALS['DEFAULT_EXHLABEL'], "Exh. label");
