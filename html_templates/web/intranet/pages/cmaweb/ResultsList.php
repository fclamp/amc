...
<title>CMA Search Results</title>
</head>

<body bgcolor="#b5b6b5">
<img align=left border="0" src="images/column.jpg" width="84" height="120">
      <h3><font face="Tahoma" color="#336699">&nbsp;CMA Search Results...</font></h3>

<center>
<?php
require_once('../../objects/cmaweb/ResultsLists.php');

$resultlist = new CmaStandardResultsList;
...
$resultlist->Intranet = 1;  //this is on a restricted page so display intranet only records
$resultlist->Show();
?>
</center>
<br><br>
