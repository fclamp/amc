...
$MediaLink->Intranet = 1;  //this is on a restricted page so display intranet only records
...
$RandomQry->Intranet = 1;  //this is on a restricted page so display intranet only records
...
$queryform->Intranet = 1;  //this is on a restricted page so display intranet only records
$queryform->Show();
?>
  </center>
</div>
