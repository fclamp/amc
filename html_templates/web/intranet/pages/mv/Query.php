...
<?php
/*
** NOTE: The date field to search on may need to change to suit individual institutions
** this query set for today - 2 years
** OTHER VERSION: $pastdate = date("d-m-Y", mktime (0,0,0,date("m")-6,date("d"),  date("Y")));
*/
$pastdate = date("d-m-Y", mktime (0,0,0,1,1,  date("Y")-2));
$MediaLink = new PreConfiguredQueryLink;
$MediaLink->Where = "AcqDateRegistered > DATE '" . $pastdate . "'";
$MediaLink->ResultsListPage = "ResultsList.php";
$MediaLink->Intranet = 1;
$MediaLink->PrintRef();
?>
...
<div align="center">
  <center>
<?php
require_once('../../objects/mv/QueryForms.php');

$queryform = new MvBasicQueryForm;
//$queryform->Restriction = "ColRecordCategory = 'Registered'";
$queryform->FontFace = 'Tahoma, Arial';
$queryform->FontSize = '2';
$queryform->TitleTextColor = '#FFFFFF';
$queryform->BorderColor = '#336699';
$queryform->BodyColor = '#ffffe8';
$queryform->HelpPage = '/emuweb/examples/shared/help/MvBasicQueryHelp.php';
