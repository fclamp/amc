...
class NanoPlaylist extends Playlist
{
	public function
	NanoPlaylist()
	{
		$this->Playlist();
		$this->name = 'nanoplaylist';
		$this->title = 'Playlist for iPod Nano';
	}
...
<?php
	...
	loadItem($narrative)
	{
		$item = new NanoPlaylistItem($narrative);
...
class NanoPlaylistItem extends PlaylistItem
{
	public function
	NanoPlaylistItem($narrative)
	{
		$this->PlaylistItem($narrative);
	}
}

$Publication = new NanoPlaylist;
?>
